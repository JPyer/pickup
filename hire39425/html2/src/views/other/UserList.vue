    ...
    >
      <div
        ...
        <a-row
          ...
          <a-col :span="12" v-for="(role, index) in record.permissions" :key="index" :style="{ marginBottom: '12px', height: '52px' }">
            <a-col :lg="7" :md="24">
              <span>{{ role.permissionName }}：</span>
            </a-col>
            <a-col :lg="20" :md="24" v-if="role.actionEntitySet && role.actionEntitySet.length > 0">
              <a-tag color="cyan" v-for="action in role.actionEntitySet" :key="action">{{ action.describe }}</a-tag>
            </a-col>
